...
("function" == typeof define && define.amd
    ...
    return (function () {
            ...
            e = {
                clear: function (e, t) {
                    ...
                    h || w(n),
                        o(e, n, t) ||
                            (function (e) {
                                for (var t = h.children(), n = t.length - 1; 0 <= n; n--) o(D(t[n]), e);
                            })(n);
                },
                remove: function (e) {
                    var t = O();
                ...
                error: function (e, t, n) {
                    return i({ type: s.error, iconClass: O().iconClasses.error, message: e, optionsOverride: n, title: t });
                },
                getContainer: w,
                info: function (e, t, n) {
                    return i({ type: s.info, iconClass: O().iconClasses.info, message: e, optionsOverride: n, title: t });
                },
                options: {},
                ...
                success: function (e, t, n) {
                    return i({ type: s.success, iconClass: O().iconClasses.success, message: e, optionsOverride: n, title: t });
                },
                version: "2.1.4",
                warning: function (e, t, n) {
                    return i({ type: s.warning, iconClass: O().iconClasses.warning, message: e, optionsOverride: n, title: t });
                },
            };
        return e;
        function w(e, t) {
        ...
        function i(t) {
            ...
            if (
                (void 0 !== t.optionsOverride && ((o = D.extend(o, t.optionsOverride)), (e = t.optionsOverride.iconClass || e)),
                !(function (e, t) {
                ...
                var i = null,
                    ...
                    d = { toastId: C, state: "visible", startTime: new Date(), options: o, map: t };
                return (
                    t.iconClass && a.addClass(o.toastClass).addClass(e),
                    (function () {
                        if (t.title) {
                            var e = t.title;
                    ...
                    o.closeButton && (l.addClass(o.closeClass).attr("role", "button"), a.prepend(l)),
                    o.progressBar && (r.addClass(o.progressClass), a.prepend(r)),
                    o.rtl && a.addClass("rtl"),
                    o.newestOnTop ? h.prepend(a) : h.append(a),
                    (function () {
                        var e = "";
                        switch (t.iconClass) {
                            case "toast-success":
                    ...
                    a.hide(),
                    a[o.showMethod]({ duration: o.showDuration, easing: o.showEasing, complete: o.onShown }),
                    0 < o.timeOut && ((i = setTimeout(p, o.timeOut)), (c.maxHideTime = parseFloat(o.timeOut)), (c.hideEta = new Date().getTime() + c.maxHideTime), o.progressBar && (c.intervalId = setInterval(f, 10))),
                    o.closeOnHover && a.hover(m, g),
            ...
            function m() {
                clearTimeout(i), (c.hideEta = 0), a.stop(!0, !0)[o.showMethod]({ duration: o.showDuration, easing: o.showEasing });
            }
            function f() {
