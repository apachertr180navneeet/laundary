                ...
                <div class="card-body">
                    <div class="row justify-content-between mb-3 align-items-center">
                        ...
                        <div class="col-lg-3 mb-2 text-end">
                            ...
                            <a class="btn btn-primary"  href="{{ url('/erp/download-receipt/' . $order->id) }}" type="button"><i class="fa-solid fa-download"></i></a>
                                               <a class="btn btn-primary" href="{{ url('/erp/receipt-print/' . $order->id) }}"
