                ...
                <div class="card-body">
                    <div class="row justify-content-between mb-3">
                        ...
                        <div class="col-lg-3 mb-2 text-end">
                            ...
                            <a class="btn btn-primary"  href="{{ url('/erp/download-invoice/' . $order->id) }}" type="button"><i class="fa-solid fa-download"></i></a>

                            <a class="btn btn-primary" href="{{ url('/erp/invoice-print/' . $order->id) }}"
                                type="button"><i class="fa-solid fa-print me-2"></i></a>
                        </div>
                    </div>

{{-- <img src="{{ url('theam/Images/logo.png') }}" class="mt-0 mb-3" style="width: 200px;"> --}}
                     @include('erp.invoiceDetail');
    ...
    <script>
        document.getElementById('backButton').addEventListener('click', function() {
            ...
            if (referrerUrl.includes('/erp/view-order')) {
                window.location.href = referrerUrl;
            } else {
                window.location.href = "{{ url('/erp/invoice') }}";
            }
        });
    </script>
    <script>
