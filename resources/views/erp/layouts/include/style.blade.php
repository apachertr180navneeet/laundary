 ...
 <link rel="stylesheet" href="{{url('/theam/assets/vendor/css/rtl/core.css')}}" class="template-customizer-core-css" />
 <link rel="stylesheet" href="{{url('/theam/assets/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css" />
 <link rel="stylesheet" href="{{url('/theam/assets/css/demo.css')}}" />
 <link rel="stylesheet" href="{{url('/theam/assets/css/premium.css')}}" />
 ...
 <link rel="stylesheet" href="{{url('/theam/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css')}}" />
 <!-- Page CSS -->
 <link rel="stylesheet" href="{{url('/theam/assets/vendor/css/pages/cards-advance.css')}}" />
