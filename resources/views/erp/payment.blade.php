                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($payments as $payment)
                                        <tr>
                                            <td>{{ $serialNumber++ }}</td>
                                            <td><a href="{{ url('/erp/show-order/' . $payment->order_prim_id) }}" class="btn Client_table_action_icon px-2" style="color: #7367f0;">{{ $payment->order_number }}</a></td>
                        ...
                        success: function(response) {
                            ...
                            $.each(payments, function(index, payment) {
                                ...
                                var row = `
                                    <tr>
                                        <td>${serialNumber++}</td>
                                        <td><a href="/erp/show-order/${payment.order_prim_id}" class="btn Client_table_action_icon px-2" style="color: #7367f0;">${payment.order_number}</a></td>
                                        <td>${formattedDate}</td>
                                        <td>${payment.payment_type}</td>
                                        <td>₹ ${payment.total_amount}</td>
                                    </tr>
