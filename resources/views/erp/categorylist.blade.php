...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#confirm_delete').click(function() {
            ...
            $.ajax({
                url: '/erp/delete-clothes/' + tenantId,
                type: 'post',
                data: formData,
                success: function(response) {
