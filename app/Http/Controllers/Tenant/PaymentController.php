        ...
        try {
            ...
            if(!$invoiceNumberCheck){
                ...
                $invoice = Invoice::create([
                    'order_id' => $orderId,
                    'invoice_number' => $lastInvoiceNumber->invoice_number + 1
            ...
            $curl = curl_init();
            $message = $order->order_number . ' ' . 'amounting to' . ' ' . $order->total_price .' '.' for '.$order->total_qty . ' ' .'items is';
            $payload = json_encode([
